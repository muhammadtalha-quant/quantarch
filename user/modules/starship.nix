{
    ...
    programs.starship = {
        ...
        settings = {
            ...
            format = "[](base09)$os$username[](bg:base0a fg:base09)$directory[](fg:base0a bg:base0c)$git_branch$git_status[](fg:base0c bg:base0d)$typst$cmake$c$cpp$python[](fg:base0d bg:base01)$time[ ](fg:base01)$line_break$character";
